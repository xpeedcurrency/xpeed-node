...
#ifdef XPD_SECURE_RPC
#include <xpeed/node/rpc_secure.hpp>
#endif
...
namespace
{
void construct_json (xpeed::seq_con_info_component * component, boost::property_tree::ptree & parent);
}

xpeed::rpc_secure_config::rpc_secure_config () :
enable (false),
verbose_logging (false)
{
}

xpeed::error xpeed::rpc_secure_config::serialize_json (xpeed::jsonconfig & json) const
{
...
xpeed::error xpeed::rpc_secure_config::deserialize_json (xpeed::jsonconfig & json)
{
...
xpeed::rpc_config::rpc_config (bool enable_control_a) :
address (boost::asio::ip::address_v6::loopback ()),
port (xpeed::rpc::rpc_port),
...
xpeed::error xpeed::rpc_config::serialize_json (xpeed::jsonconfig & json) const
{
...
xpeed::error xpeed::rpc_config::deserialize_json (xpeed::jsonconfig & json)
{
...
xpeed::rpc::rpc (boost::asio::io_context & io_ctx_a, xpeed::node & node_a, xpeed::rpc_config const & config_a) :
acceptor (io_ctx_a),
config (config_a),
node (node_a)
{
...
void xpeed::rpc::add_block_observer ()
{
	node.observers.blocks.add ([this](std::shared_ptr<xpeed::block> block_a, xpeed::account const & account_a, xpeed::uint128_t const &, bool) {
		observer_action (account_a);
	});
}

void xpeed::rpc::start (bool rpc_enabled_a)
{
	if (rpc_enabled_a)
	{
		auto endpoint (xpeed::tcp_endpoint (config.address, config.port));
...
void xpeed::rpc::accept ()
{
	auto connection (std::make_shared<xpeed::rpc_connection> (node, *this));
...
xpeed::rpc_handler::rpc_handler (xpeed::node & node_a, xpeed::rpc & rpc_a, std::string const & body_a, std::string const & request_id_a, std::function<void(boost::property_tree::ptree const &)> const & response_a) :
body (body_a),
...
void xpeed::rpc::observer_action (xpeed::account const & account_a)
{
	std::shared_ptr<xpeed::payment_observer> observer;
	{
...
void xpeed::error_response (std::function<void(boost::property_tree::ptree const &)> response_a, std::string const & message_a)
{
...
void xpeed::rpc_handler::response_errors ()
{
...
std::shared_ptr<xpeed::wallet> xpeed::rpc_handler::wallet_impl ()
{
	if (!ec)
	{
		...
		if (!wallet.decode_hex (wallet_text))
		{
			...
			{
				ec = xpeed::error_common::wallet_not_found;
			}
		}
		else
		{
			ec = xpeed::error_common::bad_wallet_number;
		}
	}
	return nullptr;
}

bool xpeed::rpc_handler::wallet_locked_impl (xpeed::transaction const & transaction_a, std::shared_ptr<xpeed::wallet> wallet_a)
{
	bool result (false);
	if (!ec)
	{
		...
		{
			ec = xpeed::error_common::wallet_locked;
			result = true;
		}
	}
	return result;
...
bool xpeed::rpc_handler::wallet_account_impl (xpeed::transaction const & transaction_a, std::shared_ptr<xpeed::wallet> wallet_a, xpeed::account const & account_a)
{
	bool result (false);
	if (!ec)
	{
		...
		{
			ec = xpeed::error_common::account_not_found_wallet;
		}
	}
	return result;
}

xpeed::account xpeed::rpc_handler::account_impl (std::string account_text)
{
...
xpeed::amount xpeed::rpc_handler::amount_impl ()
{
	xpeed::amount result (0);
	if (!ec)
	{
		std::string amount_text (request.get<std::string> ("amount"));
		if (result.decode_dec (amount_text))
		{
			ec = xpeed::error_common::invalid_amount;
		}
	}
	return result;
}

std::shared_ptr<xpeed::block> xpeed::rpc_handler::block_impl (bool signature_work_required)
{
	...
	if (!ec)
	{
		...
		result = xpeed::deserialize_block_json (block_l);
		if (result == nullptr)
		{
			ec = xpeed::error_blocks::invalid_block;
		}
	}
	return result;
}

xpeed::block_hash xpeed::rpc_handler::hash_impl (std::string search_text)
{
	...
	if (!ec)
	{
		...
		{
			ec = xpeed::error_blocks::invalid_block_hash;
		}
	}
	return result;
}

xpeed::amount xpeed::rpc_handler::threshold_optional_impl ()
{
	xpeed::amount result (0);
	...
	if (!ec && threshold_text.is_initialized ())
	{
		...
		{
			ec = xpeed::error_common::bad_threshold;
		}
	}
	return result;
}

uint64_t xpeed::rpc_handler::work_optional_impl ()
{
	uint64_t result (0);
	boost::optional<std::string> work_text (request.get_optional<std::string> ("work"));
	if (!ec && work_text.is_initialized ())
	{
		if (xpeed::from_string_hex (work_text.get (), result))
		{
			ec = xpeed::error_common::bad_work_format;
		}
	}
	return result;
}
...
uint64_t xpeed::rpc_handler::count_impl ()
{
	uint64_t result (0);
	if (!ec)
	{
		...
		{
			ec = xpeed::error_common::invalid_count;
		}
	}
	return result;
}

uint64_t xpeed::rpc_handler::count_optional_impl (uint64_t result)
{
...
uint64_t xpeed::rpc_handler::offset_optional_impl (uint64_t result)
{
	...
	if (!ec && offset_text.is_initialized ())
	{
		...
		{
			ec = xpeed::error_rpc::invalid_offset;
		}
	}
	return result;
}

bool xpeed::rpc_handler::rpc_control_impl ()
{
	bool result (false);
	if (!ec)
	{
		...
		{
			ec = xpeed::error_rpc::rpc_control_disabled;
		}
		else
		{
			result = true;
...
void xpeed::rpc_handler::account_balance ()
{
...
void xpeed::rpc_handler::account_block_count ()
{
	auto account (account_impl ());
	if (!ec)
	{
		...
		{
			ec = xpeed::error_common::account_not_found;
		}
	}
	response_errors ();
}

void xpeed::rpc_handler::account_create ()
{
	rpc_control_impl ();
	...
	if (!ec)
	{
		...
		if (index_text.is_initialized ())
		{
			...
			{
				ec = xpeed::error_common::invalid_index;
			}
			else
			{
...
void xpeed::rpc_handler::account_get ()
{
	...
	{
		ec = xpeed::error_common::bad_public_key;
	}
	response_errors ();
}

void xpeed::rpc_handler::account_info ()
{
	auto account (account_impl ());
	if (!ec)
	{
		...
		if (!node.store.account_get (transaction, account, info))
		{
			...
			std::string balance;
			xpeed::uint128_union (info.balance).encode_dec (balance);
			response_l.put ("balance", balance);
			response_l.put ("modified_timestamp", std::to_string (info.modified));
			response_l.put ("block_count", std::to_string (info.block_count));
			response_l.put ("account_version", info.epoch == xpeed::epoch::epoch_1 ? "1" : "0");
			if (representative)
			{
...
void xpeed::rpc_handler::account_key ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::account_list ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
		...
		for (auto i (wallet->store.begin (transaction)), j (wallet->store.end ()); i != j; ++i)
		{
			...
			entry.put ("", xpeed::account (i->first).to_account ());
...
void xpeed::rpc_handler::account_move ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
	{
		...
		if (!source.decode_hex (source_text))
		{
			...
			if (existing != node.wallets.items.end ())
			{
				...
				std::vector<xpeed::public_key> accounts;
				for (auto i (accounts_text.begin ()), n (accounts_text.end ()); i != n; ++i)
				{
					xpeed::public_key account;
			...
			{
				ec = xpeed::error_rpc::source_not_found;
			}
		}
		else
		{
			ec = xpeed::error_rpc::bad_source;
		}
	}
	response_errors ();
}

void xpeed::rpc_handler::account_remove ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	auto account (account_impl ());
...
void xpeed::rpc_handler::account_representative ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::account_representative_set ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	if (!ec)
	{
		...
		if (!representative.decode_account (representative_text))
		{
			...
			if (!ec && work)
			{
				...
				if (!ec)
				{
					...
					{
						if (xpeed::work_validate (info.head, work))
						{
							ec = xpeed::error_common::invalid_work;
						}
					}
					else
					{
			...
			if (!ec)
			{
				...
				// clang-format off
				wallet->change_async (account, representative, [response_a](std::shared_ptr<xpeed::block> block) {
					xpeed::block_hash hash (0);
					if (block != nullptr)
					{
						hash = block->hash ();
					}
		...
		{
			ec = xpeed::error_rpc::bad_representative_number;
		}
	}
...
void xpeed::rpc_handler::account_weight ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::accounts_balances ()
{
...
void xpeed::rpc_handler::accounts_create ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	...
	if (!ec)
	{
		...
		{
			xpeed::account new_key (wallet->deterministic_insert (generate_work));
			if (!new_key.is_zero ())
			{
				boost::property_tree::ptree entry;
...
void xpeed::rpc_handler::accounts_frontiers ()
{
...
void xpeed::rpc_handler::accounts_pending ()
{
	...
	for (auto & accounts : request.get_child ("accounts"))
	{
		...
		if (!ec)
		{
			...
			for (auto i (node.store.pending_begin (transaction, xpeed::pending_key (account, 0))); xpeed::pending_key (i->first).account == account && peers_l.size () < count; ++i)
			{
				xpeed::pending_key key (i->first);
				std::shared_ptr<xpeed::block> block (include_active ? nullptr : node.store.block_get (transaction, key.hash));
...
void xpeed::rpc_handler::available_supply ()
{
	auto genesis_balance (node.balance (xpeed::genesis_account)); // Cold storage genesis
	auto landing_balance (node.balance (xpeed::account ("059F68AAB29DE0D3A27443625C7EA9CDDB6517A8B76FE37727EF6A4D76832AD5"))); // Active unavailable account
	auto faucet_balance (node.balance (xpeed::account ("8E319CE6F3025E5B2DF66DA7AB1467FE48F1679C13DD43BFDB29FA2E9FC40D3B"))); // Faucet account
	auto burned_balance ((node.balance_pending (xpeed::account (0))).second); // Burning 0 account
	auto available (xpeed::genesis_amount - genesis_balance - landing_balance - faucet_balance - burned_balance);
	response_l.put ("available", available.convert_to<std::string> ());
	response_errors ();
}

void xpeed::rpc_handler::block_info ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
		...
		if (block != nullptr)
		{
			xpeed::account account (block->account ().is_zero () ? sideband.account : block->account ());
		...
		{
			ec = xpeed::error_blocks::not_found;
		}
	}
	response_errors ();
}

void xpeed::rpc_handler::block_confirm ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::blocks ()
{
	...
	for (boost::property_tree::ptree::value_type & hashes : request.get_child ("hashes"))
	{
		if (!ec)
		{
			...
			{
				ec = xpeed::error_blocks::bad_hash_number;
			}
		}
	}
...
void xpeed::rpc_handler::blocks_info ()
{
	const bool pending = request.get<bool> ("pending", false);
	const bool source = request.get<bool> ("source", false);
	std::vector<std::string> hashes;
			...
			if (!hash.decode_hex (hash_text))
			{
				...
				if (block != nullptr)
				{
					...
					if (pending)
					{
						...
						{
							exists = node.store.pending_exists (transaction, xpeed::pending_key (destination, hash));
						}
						entry.put ("pending", exists ? "1" : "0");
					}
					if (source)
					{
						xpeed::block_hash source_hash (node.ledger.block_source (transaction, *block));
...
void xpeed::rpc_handler::block_account ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::block_count ()
{
	auto transaction (node.store.tx_begin_read ());
...
void xpeed::rpc_handler::block_count_type ()
{
	auto transaction (node.store.tx_begin_read ());
	xpeed::block_counts count (node.store.block_count (transaction));
...
void xpeed::rpc_handler::block_create ()
{
	rpc_control_impl ();
	if (!ec)
	{
		std::string type (request.get<std::string> ("type"));
		xpeed::uint256_union wallet (0);
		...
		xpeed::uint256_union representative (0);
		...
		xpeed::uint256_union destination (0);
		...
		if (!ec && destination_text.is_initialized ())
		{
			...
			{
				ec = xpeed::error_rpc::bad_destination;
			}
		}
		xpeed::block_hash source (0);
		...
		xpeed::raw_key prv;
		prv.data.clear ();
		xpeed::uint256_union previous (0);
		xpeed::uint128_union balance (0);
		...
		if (!ec && key_text.is_initialized ())
		{
			...
			{
				ec = xpeed::error_common::bad_private_key;
			}
		}
		...
		if (!ec && previous_text.is_initialized ())
		{
			...
			{
				ec = xpeed::error_rpc::bad_previous;
			}
		}
		...
		if (!ec && balance_text.is_initialized ())
		{
			...
			{
				ec = xpeed::error_rpc::invalid_balance;
			}
		}
		xpeed::uint256_union link (0);
		...
		if (prv.data != 0)
		{
			xpeed::uint256_union pub (xpeed::pub_key (prv.data));
			...
			else if (previous_text.is_initialized () && balance_text.is_initialized () && type == "send")
			{
				...
				{
					ec = xpeed::error_rpc::block_create_balance_mismatch;
				}
			}
			...
			if (!ec && account_text.is_initialized ())
			{
				if (account != pub)
				{
					ec = xpeed::error_rpc::block_create_public_key_mismatch;
				}
			}
			if (type == "state")
			{
				if (previous_text.is_initialized () && !representative.is_zero () && (!link.is_zero () || link_text.is_initialized ()))
				{
					...
					xpeed::state_block state (pub, previous, representative, balance, link, prv, pub, work);
				...
				{
					ec = xpeed::error_rpc::block_create_requirements_state;
				}
			}
			else if (type == "open")
			{
				if (representative != 0 && source != 0)
				{
					...
					xpeed::open_block open (source, representative, pub, prv, pub, work);
				...
				{
					ec = xpeed::error_rpc::block_create_requirements_open;
				}
			}
			else if (type == "receive")
			{
				if (source != 0 && previous != 0)
				{
					...
					xpeed::receive_block receive (previous, source, prv, pub, work);
				...
				{
					ec = xpeed::error_rpc::block_create_requirements_receive;
				}
			}
			else if (type == "change")
			{
				if (representative != 0 && previous != 0)
				{
					...
					xpeed::change_block change (previous, representative, prv, pub, work);
				...
				{
					ec = xpeed::error_rpc::block_create_requirements_change;
				}
			}
			else if (type == "send")
			{
				if (destination != 0 && previous != 0 && balance != 0 && amount != 0)
				{
					if (balance.number () >= amount.number ())
					{
						...
						xpeed::send_block send (previous, destination, balance.number () - amount.number (), prv, pub, work);
					...
					{
						ec = xpeed::error_common::insufficient_balance;
					}
				}
				else
				{
					ec = xpeed::error_rpc::block_create_requirements_send;
				}
			}
			else
			{
				ec = xpeed::error_blocks::invalid_type;
			}
		}
		else
		{
			ec = xpeed::error_rpc::block_create_key_required;
		}
	}
	response_errors ();
}

void xpeed::rpc_handler::block_hash ()
{
...
void xpeed::rpc_handler::bootstrap ()
{
	...
	{
		uint16_t port;
		if (!xpeed::parse_port (port_text, port))
		{
			node.bootstrap_initiator.bootstrap (xpeed::endpoint (address, port));
			response_l.put ("success", "");
		}
		else
		{
			ec = xpeed::error_common::invalid_port;
		}
	}
	else
	{
		ec = xpeed::error_common::invalid_ip_address;
	}
	response_errors ();
}

void xpeed::rpc_handler::bootstrap_any ()
{
...
void xpeed::rpc_handler::bootstrap_lazy ()
{
	rpc_control_impl ();
	auto hash (hash_impl ());
 ...
 */
void xpeed::rpc_handler::bootstrap_status ()
{
	...
	if (attempt != nullptr)
	{
		...
		else if (attempt->mode == xpeed::bootstrap_mode::wallet_lazy)
		{
...
void xpeed::rpc_handler::chain (bool successors)
{
...
void xpeed::rpc_handler::confirmation_active ()
{
...
void xpeed::rpc_handler::confirmation_history ()
{
	boost::property_tree::ptree elections;
...
void xpeed::rpc_handler::confirmation_info ()
{
	...
	if (!root.decode_hex (root_text))
	{
		...
		if (conflict_info != node.active.roots.end ())
		{
			...
			for (auto i (tally_l.begin ()), n (tally_l.end ()); i != n; ++i)
			{
				...
				if (representatives)
				{
					std::multimap<xpeed::uint128_t, xpeed::account, std::greater<xpeed::uint128_t>> representatives;
					for (auto ii (election->last_votes.begin ()), nn (election->last_votes.end ()); ii != nn; ++ii)
					{
						if (i->second->hash () == ii->second.hash)
						{
							xpeed::account representative (ii->first);
		...
		{
			ec = xpeed::error_rpc::confirmation_not_found;
		}
	}
	else
	{
		ec = xpeed::error_rpc::invalid_root;
	}
	response_errors ();
}

void xpeed::rpc_handler::confirmation_quorum ()
{
...
void xpeed::rpc_handler::delegators ()
{
	auto account (account_impl ());
	if (!ec)
	{
		...
		for (auto i (node.store.latest_begin (transaction)), n (node.store.latest_end ()); i != n; ++i)
		{
			...
			if (block->representative () == account)
			{
				std::string balance;
				xpeed::uint128_union (info.balance).encode_dec (balance);
				delegators.put (xpeed::account (i->first).to_account (), balance);
			}
		}
...
void xpeed::rpc_handler::delegators_count ()
{
	auto account (account_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::deterministic_key ()
{
	...
	if (!seed.data.decode_hex (seed_text))
	{
		try
		{
			...
			xpeed::deterministic_key (seed.data, index, prv);
	...
	{
		ec = xpeed::error_common::bad_seed;
	}
	response_errors ();
}

void xpeed::rpc_handler::frontiers ()
{
	...
	if (!ec)
	{
		...
		{
			frontiers.put (xpeed::account (i->first).to_account (), xpeed::account_info (i->second).head.to_string ());
		}
		response_l.add_child ("frontiers", frontiers);
	}
	response_errors ();
...
void xpeed::rpc_handler::account_count ()
{
	auto transaction (node.store.tx_begin_read ());
...
namespace
{
class history_visitor : public xpeed::block_visitor
{
public:
	history_visitor (xpeed::rpc_handler & handler_a, bool raw_a, xpeed::transaction & transaction_a, boost::property_tree::ptree & tree_a, xpeed::block_hash const & hash_a) :
	handler (handler_a),
	raw (raw_a),
	...
	void open_block (xpeed::open_block const & block_a)
	{
		...
		{
			tree.put ("account", xpeed::genesis_account.to_account ());
			tree.put ("amount", xpeed::genesis_amount.convert_to<std::string> ());
		}
	}
	...
	xpeed::rpc_handler & handler;
	bool raw;
	xpeed::transaction & transaction;
	boost::property_tree::ptree & tree;
	xpeed::block_hash const & hash;
};
}

void xpeed::rpc_handler::account_history ()
{
		...
		while (block != nullptr && count > 0)
		{
			...
			else
			{
				...
				if (!entry.empty ())
				{
					...
					if (output_raw)
					{
						entry.put ("work", xpeed::to_string_hex (block->block_work ()));
...
void xpeed::rpc_handler::keepalive ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
void xpeed::rpc_handler::key_create ()
{
	xpeed::keypair pair;
...
void xpeed::rpc_handler::key_expand ()
{
	std::string key_text (request.get<std::string> ("key"));
	xpeed::uint256_union prv;
...
void xpeed::rpc_handler::ledger ()
{
	rpc_control_impl ();
	auto count (count_optional_impl ());
	if (!ec)
	{
		xpeed::account start (0);
		boost::optional<std::string> account_text (request.get_optional<std::string> ("account"));
		...
		if (modified_since_text.is_initialized ())
		{
			...
			{
				ec = xpeed::error_rpc::invalid_timestamp;
			}
		}
		...
		{
			std::vector<std::pair<xpeed::uint128_union, xpeed::account>> ledger_l;
			for (auto i (node.store.latest_begin (transaction, start)), n (node.store.latest_end ()); i != n; ++i)
			{
				xpeed::account_info info (i->second);
				xpeed::uint128_union balance (info.balance);
				if (info.modified >= modified_since)
				{
					ledger_l.push_back (std::make_pair (balance, xpeed::account (i->first)));
				}
			}
			...
			for (auto i (ledger_l.begin ()), n (ledger_l.end ()); i != n && accounts.size () < count; ++i)
			{
				...
				xpeed::account account (i->second);
				boost::property_tree::ptree response_a;
				response_a.put ("frontier", info.head.to_string ());
				response_a.put ("open_block", info.open_block.to_string ());
				response_a.put ("representative_block", info.rep_block.to_string ());
...
void xpeed::rpc_handler::mxpd_from_raw (xpeed::uint128_t ratio)
{
...
void xpeed::rpc_handler::mxpd_to_raw (xpeed::uint128_t ratio)
{
	auto amount (amount_impl ());
	if (!ec)
	{
		...
		{
			ec = xpeed::error_common::invalid_amount_big;
		}
	}
	response_errors ();
}
 ...
 * @warning This is an internal/diagnostic RPC, do not rely on its interface being stable
 */
void xpeed::rpc_handler::node_id ()
{
	rpc_control_impl ();
	if (!ec)
	{
 ...
 * @warning This is an internal/diagnostic RPC, do not rely on its interface being stable
 */
void xpeed::rpc_handler::node_id_delete ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
void xpeed::rpc_handler::password_change ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
...
void xpeed::rpc_handler::password_enter ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::password_valid (bool wallet_locked)
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::pending ()
{
	auto account (account_impl ());
	auto count (count_optional_impl ());
	auto threshold (threshold_optional_impl ());
				...
				else
				{
					...
					if (info.amount.number () >= threshold.number ())
					{
						if (source || min_version)
						{
							...
							if (min_version)
							{
								pending_tree.put ("min_version", info.epoch == xpeed::epoch::epoch_1 ? "1" : "0");
							}
							peers_l.add_child (key.hash.to_string (), pending_tree);
						}
						else
...
void xpeed::rpc_handler::pending_exists ()
{
	auto hash (hash_impl ());
	const bool include_active = request.get<bool> ("include_active", false);
	if (!ec)
...
void xpeed::rpc_handler::payment_begin ()
{
	...
	if (!id.decode_hex (id_text))
	{
		...
		{
			auto transaction (node.wallets.tx_begin_write ());
			std::shared_ptr<xpeed::wallet> wallet (existing->second);
			if (wallet->store.valid_password (transaction))
			{
				...
				{
					ec = xpeed::error_rpc::payment_unable_create_account;
				}
			}
			else
			{
...
void xpeed::rpc_handler::payment_init ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::payment_end ()
{
	auto account (account_impl ());
	auto wallet (wallet_impl ());
	if (!ec)
	{
		...
		if (!ec)
		{
			...
			{
				ec = xpeed::error_rpc::payment_account_balance;
			}
		}
	}
	response_errors ();
...
void xpeed::rpc_handler::payment_wait ()
{
	...
	if (!ec)
	{
		...
		{
			{
				auto observer (std::make_shared<xpeed::payment_observer> (response, rpc, account, amount));
		...
		{
			ec = xpeed::error_rpc::bad_timeout;
		}
	}
	if (ec)
	{
		...
		if (!subtype_text.empty ())
		{
			...
			else
			{
				...
				if (subtype_text == "send")
				{
					...
					{
						ec = xpeed::error_rpc::invalid_subtype_balance;
					}
				...
				else if (subtype_text == "open")
				{
					...
					{
						ec = xpeed::error_rpc::invalid_subtype_previous;
					}
				}
				...
				else if (subtype_text == "epoch")
				{
					...
					{
						ec = ec = xpeed::error_rpc::invalid_subtype_epoch_link;
					}
				}
				else
				{
					ec = xpeed::error_rpc::invalid_subtype;
				}
			}
		}
	}
	if (!ec)
	{
		if (!xpeed::work_validate (*block))
		{
			...
			xpeed::process_return result;
			{
				...
				xpeed::unchecked_info info (block, block->account (), xpeed::seconds_since_epoch (), xpeed::signature_verification::unknown);
			...
			switch (result.code)
			{
				...
				case xpeed::process_result::fork:
				{
					...
					{
						ec = xpeed::error_process::fork;
					}
					break;
				}
				default:
				{
					ec = xpeed::error_process::other;
					break;
				}
			}
		}
		...
		{
			ec = xpeed::error_blocks::work_low;
		}
	}
	response_errors ();
}

void xpeed::rpc_handler::receive ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	...
	if (!ec)
	{
		...
		if (!ec)
		{
			...
			if (block != nullptr)
			{
				if (node.store.pending_exists (block_transaction, xpeed::pending_key (account, hash)))
				{
					auto work (work_optional_impl ());
					if (!ec && work)
					{
						xpeed::account_info info;
						xpeed::uint256_union head;
						if (!node.store.account_get (block_transaction, account, info))
						{
							head = info.head;
						}
						...
						if (xpeed::work_validate (head, work))
						{
							ec = xpeed::error_common::invalid_work;
						}
					}
					if (!ec)
					{
						...
						auto response_a (response);
						// clang-format off
						wallet->receive_async (std::move (block), account, xpeed::genesis_amount, [response_a](std::shared_ptr<xpeed::block> block_a) {
							xpeed::uint256_union hash_a (0);
							if (block_a != nullptr)
							{
								hash_a = block_a->hash ();
							}
...
void xpeed::rpc_handler::receive_minimum ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
void xpeed::rpc_handler::receive_minimum_set ()
{
	rpc_control_impl ();
	auto amount (amount_impl ());
	if (!ec)
...
void xpeed::rpc_handler::representatives ()
{
	auto count (count_optional_impl ());
	if (!ec)
	{
		...
		{
			std::vector<std::pair<xpeed::uint128_union, std::string>> representation;
...
void xpeed::rpc_handler::representatives_online ()
{
	const auto accounts_node = request.get_child_optional ("accounts");
	const bool weight = request.get<bool> ("weight", false);
	std::vector<xpeed::public_key> accounts_to_filter;
...
void xpeed::rpc_handler::republish ()
{
	...
	if (!ec && sources_text.is_initialized ())
	{
		...
		{
			ec = xpeed::error_rpc::invalid_sources;
		}
	}
	...
	if (!ec && destinations_text.is_initialized ())
	{
		...
		{
			ec = xpeed::error_rpc::invalid_destinations;
		}
	}
	auto hash (hash_impl ());
	if (!ec)
	{
		...
		if (block != nullptr)
		{
			std::deque<std::shared_ptr<xpeed::block>> republish_bundle;
			for (auto i (0); !hash.is_zero () && i < count; ++i)
			{
				block = node.store.block_get (transaction, hash);
				if (sources != 0) // Republish source chain
				{
					xpeed::block_hash source (node.ledger.block_source (transaction, *block));
					auto block_a (node.store.block_get (transaction, source));
					std::vector<xpeed::block_hash> hashes;
				...
				if (destinations != 0) // Republish destination chain
				{
					...
					if (!destination.is_zero ())
					{
						if (!node.store.pending_exists (transaction, xpeed::pending_key (destination, hash)))
						{
							xpeed::block_hash previous (node.ledger.latest (transaction, destination));
...
void xpeed::rpc_handler::search_pending ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
...
void xpeed::rpc_handler::search_pending_all ()
{
	rpc_control_impl ();
	if (!ec)
	{
		...
		if (!source.decode_account (source_text))
		{
			...
			if (!destination.decode_account (destination_text))
			{
				...
				if (!ec)
				{
					...
					auto response_a (response);
					// clang-format off
					wallet->send_async (source, destination, amount.number (), [balance, amount, response_a](std::shared_ptr<xpeed::block> block_a) {
						if (block_a != nullptr)
						{
							xpeed::uint256_union hash (block_a->hash ());
							boost::property_tree::ptree response_l;
							response_l.put ("block", hash.to_string ());
							response_a (response_l);
						}
						else
						{
							...
							{
								std::error_code ec (xpeed::error_common::insufficient_balance);
...
void xpeed::rpc_handler::sign ()
{
	...
	{
		ec = xpeed::error_rpc::sign_hash_disabled;
	}
	if (!ec)
	{
		xpeed::raw_key prv;
		...
		if (prv.data != 0)
		{
			...
			xpeed::signature signature (xpeed::sign_message (prv, pub, hash));
...
void xpeed::rpc_handler::stats ()
{
	...
	{
		ec = xpeed::error_rpc::invalid_missing_type;
	}
	if (!ec && use_sink)
	{
...
void xpeed::rpc_handler::stats_clear ()
{
	node.stats.clear ();
	response_l.put ("success", "");
	response (response_l);
...
void xpeed::rpc_handler::unchecked ()
{
	auto count (count_optional_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::unchecked_clear ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
void xpeed::rpc_handler::unchecked_get ()
{
	auto hash (hash_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::unchecked_keys ()
{
	auto count (count_optional_impl ());
	...
	if (!ec)
	{
		boost::property_tree::ptree unchecked;
		auto transaction (node.store.tx_begin_read ());
		for (auto i (node.store.unchecked_begin (transaction, xpeed::unchecked_key (key, 0))), n (node.store.unchecked_end ()); i != n && unchecked.size () < count; ++i)
		{
			boost::property_tree::ptree entry;
			xpeed::unchecked_info info (i->second);
			std::string contents;
			info.block->serialize_json (contents);
			entry.put ("key", xpeed::block_hash (i->first.key ()).to_string ());
...
void xpeed::rpc_handler::uptime ()
{
	response_l.put ("seconds", std::chrono::duration_cast<std::chrono::seconds> (std::chrono::steady_clock::now () - node.startup_time).count ());
	response_errors ();
}

void xpeed::rpc_handler::version ()
{
	response_l.put ("rpc_version", "1");
	response_l.put ("store_version", std::to_string (node.store_version ()));
	response_l.put ("protocol_version", std::to_string (xpeed::protocol_version));
	if (XPD_VERSION_PATCH == 0)
	{
		response_l.put ("node_vendor", boost::str (boost::format ("Xpeed %1%") % XPD_MAJOR_MINOR_VERSION));
	}
	else
	{
		response_l.put ("node_vendor", boost::str (boost::format ("Xpeed %1%") % XPD_MAJOR_MINOR_RC_VERSION));
	}
	response_errors ();
}

void xpeed::rpc_handler::validate_account_number ()
{
...
void xpeed::rpc_handler::wallet_add ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
...
void xpeed::rpc_handler::wallet_add_watch ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
...
void xpeed::rpc_handler::wallet_info ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
		...
		for (auto i (wallet->store.begin (transaction)), n (wallet->store.end ()); i != n; ++i)
		{
			...
			xpeed::key_type key_type (wallet->store.key_type (i->second));
			if (key_type == xpeed::key_type::deterministic)
			{
				deterministic_count++;
			}
			else if (key_type == xpeed::key_type::adhoc)
			{
				adhoc_count++;
			}
			count++;
...
void xpeed::rpc_handler::wallet_balances ()
{
	auto wallet (wallet_impl ());
	auto threshold (threshold_optional_impl ());
	if (!ec)
	{
		...
		{
			xpeed::account account (i->first);
			xpeed::uint128_t balance = node.ledger.account_balance (block_transaction, account);
			if (balance >= threshold.number ())
			{
				boost::property_tree::ptree entry;
				xpeed::uint128_t pending = node.ledger.account_pending (block_transaction, account);
				entry.put ("balance", balance.convert_to<std::string> ());
...
void xpeed::rpc_handler::wallet_change_seed ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
...
void xpeed::rpc_handler::wallet_contains ()
{
	auto account (account_impl ());
	auto wallet (wallet_impl ());
	if (!ec)
...
void xpeed::rpc_handler::wallet_create ()
{
	rpc_control_impl ();
	if (!ec)
	{
		...
		if (!ec)
		{
			...
			{
				ec = xpeed::error_common::wallet_lmdb_max_dbs;
			}
			if (!ec && seed_text.is_initialized ())
			{
				auto transaction (node.wallets.tx_begin_write ());
				xpeed::public_key account (wallet->change_seed (transaction, seed));
				response_l.put ("account", account.to_account ());
			}
		}
	}
...
void xpeed::rpc_handler::wallet_destroy ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
void xpeed::rpc_handler::wallet_export ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::wallet_frontiers ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::wallet_history ()
{
...
void xpeed::rpc_handler::wallet_key_valid ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::wallet_ledger ()
{
	const bool representative = request.get<bool> ("representative", false);
	const bool weight = request.get<bool> ("weight", false);
	const bool pending = request.get<bool> ("pending", false);
...
void xpeed::rpc_handler::wallet_lock ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
...
void xpeed::rpc_handler::wallet_pending ()
{
	auto wallet (wallet_impl ());
	auto count (count_optional_impl ());
	auto threshold (threshold_optional_impl ());
	...
	if (!ec)
	{
		...
		for (auto i (wallet->store.begin (transaction)), n (wallet->store.end ()); i != n; ++i)
		{
			xpeed::account account (i->first);
			boost::property_tree::ptree peers_l;
			for (auto ii (node.store.pending_begin (block_transaction, xpeed::pending_key (account, 0))); xpeed::pending_key (ii->first).account == account && peers_l.size () < count; ++ii)
			{
				xpeed::pending_key key (ii->first);
				std::shared_ptr<xpeed::block> block (include_active ? nullptr : node.store.block_get (block_transaction, key.hash));
				if (include_active || (block && !node.active.active (*block)))
				{
					if (threshold.is_zero () && !source)
					{
					...
					{
						xpeed::pending_info info (ii->second);
						if (info.amount.number () >= threshold.number ())
						{
							if (source || min_version)
							{
...
void xpeed::rpc_handler::wallet_representative ()
{
	auto wallet (wallet_impl ());
	if (!ec)
	{
...
void xpeed::rpc_handler::wallet_representative_set ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
	{
		...
		if (!representative.decode_account (representative_text))
		{
			...
			if (!ec && update_existing_accounts)
			{
				...
				{
					// clang-format off
					wallet->change_async (account, representative, [](std::shared_ptr<xpeed::block>) {}, 0, false);
					// clang-format on
				}
			}
		}
...
void xpeed::rpc_handler::wallet_republish ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	auto count (count_impl ());
...
void xpeed::rpc_handler::wallet_work_get ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	if (!ec)
	{
		...
		for (auto i (wallet->store.begin (transaction)), n (wallet->store.end ()); i != n; ++i)
		{
			...
			(void)error_work;
			works.put (account.to_account (), xpeed::to_string_hex (work));
		}
...
void xpeed::rpc_handler::work_generate ()
{
	rpc_control_impl ();
	auto hash (hash_impl ());
	if (!ec)
	{
		...
		auto callback = [rpc_l](boost::optional<uint64_t> const & work_a) {
			...
			{
				boost::property_tree::ptree response_l;
				response_l.put ("work", xpeed::to_string_hex (work_a.value ()));
...
void xpeed::rpc_handler::work_cancel ()
{
	rpc_control_impl ();
	auto hash (hash_impl ());
	if (!ec)
...
void xpeed::rpc_handler::work_get ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	auto account (account_impl ());
	if (!ec)
	{
		...
		if (!ec)
		{
			...
			auto error_work (wallet->store.work_get (transaction, account, work));
			(void)error_work;
			response_l.put ("work", xpeed::to_string_hex (work));
		}
	}
	response_errors ();
}

void xpeed::rpc_handler::work_set ()
{
	rpc_control_impl ();
	auto wallet (wallet_impl ());
	auto account (account_impl ());
...
void xpeed::rpc_handler::work_validate ()
{
	auto hash (hash_impl ());
	auto work (work_optional_impl ());
	if (!ec)
	{
		auto validate (xpeed::work_validate (hash, work));
		response_l.put ("valid", validate ? "0" : "1");
	}
	response_errors ();
}

void xpeed::rpc_handler::work_peer_add ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
void xpeed::rpc_handler::work_peers ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
void xpeed::rpc_handler::work_peers_clear ()
{
	rpc_control_impl ();
	if (!ec)
	{
...
xpeed::rpc_connection::rpc_connection (xpeed::node & node_a, xpeed::rpc & rpc_a) :
node (node_a.shared ()),
rpc (rpc_a),
...
void xpeed::rpc_connection::parse_connection ()
{
	read ();
}

void xpeed::rpc_connection::prepare_head (unsigned version, boost::beast::http::status status)
{
	res.version (version);
	res.result (status);
...
void xpeed::rpc_connection::write_result (std::string body, unsigned version, boost::beast::http::status status)
{
...
void xpeed::rpc_connection::read ()
{
		...
		if (!ec)
		{
			this_l->node->background ([this_l]() {
				...
				switch (method)
				{
					...
					{
						auto handler (std::make_shared<xpeed::rpc_handler> (*this_l->node, this_l->rpc, this_l->request.body (), request_id, response_handler));
...
void xpeed::rpc_handler::process_request ()
{
	try
	{
		...
		else
		{
			...
			else if (action == "kxpd_from_raw" || action == "krai_from_raw")
			{
				mxpd_from_raw (xpeed::kxpd_ratio);
			}
			else if (action == "kxpd_to_raw" || action == "krai_to_raw")
			{
				mxpd_to_raw (xpeed::kxpd_ratio);
			}
			else if (action == "ledger")
			{
				ledger ();
			}
			else if (action == "mxpd_from_raw" || action == "mrai_from_raw")
			{
				mxpd_from_raw ();
			}
			else if (action == "mxpd_to_raw" || action == "mrai_to_raw")
			{
				mxpd_to_raw ();
			}
			...
			else if (action == "xpd_from_raw" || action == "rai_from_raw")
			{
				mxpd_from_raw (xpeed::xpd_ratio);
			}
			else if (action == "xpd_to_raw" || action == "rai_to_raw")
			{
				mxpd_to_raw (xpeed::xpd_ratio);
			}
...
xpeed::payment_observer::payment_observer (std::function<void(boost::property_tree::ptree const &)> const & response_a, xpeed::rpc & rpc_a, xpeed::account const & account_a, xpeed::amount const & amount_a) :
rpc (rpc_a),
account (account_a),
amount (amount_a),
response (response_a)
...
void xpeed::payment_observer::start (uint64_t timeout)
{
	auto this_l (shared_from_this ());
	rpc.node.alarm.add (std::chrono::steady_clock::now () + std::chrono::milliseconds (timeout), [this_l]() {
		this_l->complete (xpeed::payment_status::nothing);
	});
}

xpeed::payment_observer::~payment_observer ()
{
}

void xpeed::payment_observer::observe ()
{
	if (rpc.node.balance (account) >= amount.number ())
	{
		complete (xpeed::payment_status::success);
	}
}

void xpeed::payment_observer::complete (xpeed::payment_status status)
{
	...
	if (!already)
	{
		...
		switch (status)
		{
			case xpeed::payment_status::nothing:
			{
				boost::property_tree::ptree response_l;
			...
			case xpeed::payment_status::success:
			{
				boost::property_tree::ptree response_l;
...
std::unique_ptr<xpeed::rpc> xpeed::get_rpc (boost::asio::io_context & io_ctx_a, xpeed::node & node_a, xpeed::rpc_config const & config_a)
{
...
void construct_json (xpeed::seq_con_info_component * component, boost::property_tree::ptree & parent)
{
	...
	{
		auto & leaf_info = static_cast<xpeed::seq_con_info_leaf *> (component)->get_info ();
	...
	auto composite = static_cast<xpeed::seq_con_info_composite *> (component);
