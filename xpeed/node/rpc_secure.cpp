...
bool xpeed::rpc_secure::on_verify_certificate (bool preverified, boost::asio::ssl::verify_context & ctx)
{
...
void xpeed::rpc_secure::load_certs (boost::asio::ssl::context & context_a)
{
...
xpeed::rpc_secure::rpc_secure (boost::asio::io_service & service_a, xpeed::node & node_a, xpeed::rpc_config const & config_a) :
...
void xpeed::rpc_secure::accept ()
{
	auto connection (std::make_shared<xpeed::rpc_connection_secure> (node, *this));
...
xpeed::rpc_connection_secure::rpc_connection_secure (xpeed::node & node_a, xpeed::rpc_secure & rpc_a) :
xpeed::rpc_connection (node_a, rpc_a),
stream (socket, rpc_a.ssl_context)
{
}

void xpeed::rpc_connection_secure::parse_connection ()
{
	// Perform the SSL handshake
	auto this_l = std::static_pointer_cast<xpeed::rpc_connection_secure> (shared_from_this ());
...
void xpeed::rpc_connection_secure::on_shutdown (const boost::system::error_code & error)
{
...
void xpeed::rpc_connection_secure::handle_handshake (const boost::system::error_code & error)
{
	if (!error)
	{
		read ();
...
void xpeed::rpc_connection_secure::read ()
{
	auto this_l (std::static_pointer_cast<xpeed::rpc_connection_secure> (shared_from_this ()));
				...
				switch (method)
				{
					...
					case boost::beast::http::verb::options:
					{
						...
						boost::beast::http::async_write (this_l->stream, this_l->res, [this_l](boost::system::error_code const & ec, size_t bytes_transferred) {
							...
							std::bind (
							&xpeed::rpc_connection_secure::on_shutdown,
							this_l,
							std::placeholders::_1));
