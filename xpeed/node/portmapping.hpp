...
private:
	...
	static int constexpr mapping_timeout = xpeed::is_test_network ? 53 : 3593;
	static int constexpr check_timeout = xpeed::is_test_network ? 17 : 53;
