...
void xpeed::logging::init (boost::filesystem::path const & application_path_a)
{
...
xpeed::error xpeed::logging::serialize_json (xpeed::jsonconfig & json) const
{
...
bool xpeed::logging::upgrade_json (unsigned version_a, xpeed::jsonconfig & json)
{
	json.put ("version", json_version ());
...
xpeed::error xpeed::logging::deserialize_json (bool & upgraded_a, xpeed::jsonconfig & json)
{
	int version_l;
...
bool xpeed::logging::ledger_logging () const
{
	return ledger_logging_value;
}

bool xpeed::logging::ledger_duplicate_logging () const
{
	return ledger_logging () && ledger_duplicate_logging_value;
}

bool xpeed::logging::vote_logging () const
{
	return vote_logging_value;
}

bool xpeed::logging::network_logging () const
{
	return network_logging_value;
}

bool xpeed::logging::network_message_logging () const
{
	return network_logging () && network_message_logging_value;
}

bool xpeed::logging::network_publish_logging () const
{
	return network_logging () && network_publish_logging_value;
}

bool xpeed::logging::network_packet_logging () const
{
	return network_logging () && network_packet_logging_value;
}

bool xpeed::logging::network_keepalive_logging () const
{
	return network_logging () && network_keepalive_logging_value;
}

bool xpeed::logging::network_node_id_handshake_logging () const
{
	return network_logging () && network_node_id_handshake_logging_value;
}

bool xpeed::logging::node_lifetime_tracing () const
{
	return node_lifetime_tracing_value;
}

bool xpeed::logging::insufficient_work_logging () const
{
	return network_logging () && insufficient_work_logging_value;
}

bool xpeed::logging::log_rpc () const
{
	return network_logging () && log_rpc_value;
}

bool xpeed::logging::log_ipc () const
{
	return network_logging () && log_ipc_value;
}

bool xpeed::logging::bulk_pull_logging () const
{
	return network_logging () && bulk_pull_logging_value;
}

bool xpeed::logging::callback_logging () const
{
	return network_logging ();
}

bool xpeed::logging::work_generation_time () const
{
	return work_generation_time_value;
}

bool xpeed::logging::upnp_details_logging () const
{
	return upnp_details_logging_value;
}

bool xpeed::logging::timing_logging () const
{
	return timing_logging_value;
}

bool xpeed::logging::log_to_cerr () const
{
