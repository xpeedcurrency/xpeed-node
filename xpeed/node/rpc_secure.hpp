...
{
/**
 * Specialization of xpeed::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_service & service_a, xpeed::node & node_a, xpeed::rpc_config const & config_a);
...
/**
 * Specialization of xpeed::rpc_connection for establishing TLS connections.
 * Handshakes with client certificates are supported.
 */
class rpc_connection_secure : public rpc_connection
{
public:
	rpc_connection_secure (xpeed::node &, xpeed::rpc_secure &);
